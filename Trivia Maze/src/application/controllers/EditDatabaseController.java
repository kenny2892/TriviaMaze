...
public class EditDatabaseController
{
	...
	@FXML private Group shortAnswer, trueFalse, mc, correctAnswer, fileName;
	...
	public void initialize()
	{
		...
		ObservableList<String> questionTypes = FXCollections.observableArrayList("Multiple Choice", "True False", "Short", "Video", "Sound");
	...
	public void change()
	{
		...
		try
		{
			databaseType = DatabaseType.valueOf(database);
	...
	private void add(QuestionType questionType)
	{
		...
		if(questionType == QuestionType.MULTIPLE_CHOICE || questionType == QuestionType.SOUND || questionType == QuestionType.VIDEO)
		{
			correctAnswer.setLayoutX(63);
			correctAnswer.setLayoutY(366);
			
			fileName.setLayoutX(1182);
			fileName.setLayoutY(450);
		}
	...
	public void addToDatabase()
	{
		...
		try
		{
			switch(currQuestionType)
			{
				...
				case SOUND:
					result = addMC("Insert Into SoundQuestions (Questions, Options, Answers) Values(?, ?, ?)");
					break;
				...
				case VIDEO:
					result = addMC("Insert Into VideoQuestions (Questions, Options, Answers) Values(?, ?, ?)");
					break;
			}
		}
