...
{
	private static final long serialVersionUID = 529301894184390903L;
	private Question currentQuestion;
	private ArrayList<Question> questions;
	
	public DemoDatabase()
	{
		super(DatabaseType.DEMO);
		questions = createQuestionDatabase();
	}

	private ArrayList<Question> createQuestionDatabase()
	{
		ArrayList<Question> array = new ArrayList<Question>();

		try
		{
			Connection connect = DatabaseConnection.dbConnector(DatabaseType.DEMO);
